...
class TestConfigurationLoader:
    ...
    def test_load_minimal_config(self, minimal_config: ExperimentConfig):
    ...
    def test_load_production_config(self, production_config: ExperimentConfig):
        ...
        assert production_config.logging.use_json_format == True
    ...
    def test_save_and_reload_config(self, minimal_config: ExperimentConfig, tmp_path: Path):
...
class TestLoggingConfig:
    ...
    def test_valid_log_level_string(self):
    ...
    def test_log_file_string_becomes_path(self):
    ...
    def test_valid_boolean_combinations(self, json_format: bool, console: bool):
...
class TestExecutionConfig:
    ...
    def test_valid_verbose_quiet_combinations(self, verbose: bool, quiet: bool):
...
class TestExperimentConfig:
    ...
    def test_nested_validation_propagation(self, invalid_config_path: Path):
        """Test that validation errors in nested configs are caught."""
        with pytest.raises((ConfigurationError, ValueError)):
            ConfigurationLoader.load_toml(invalid_config_path)

    def test_config_modification(self, minimal_config: ExperimentConfig):
    ...
    def test_config_serialization(self, minimal_config: ExperimentConfig):
